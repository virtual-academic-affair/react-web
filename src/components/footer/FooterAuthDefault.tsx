export default function Footer() {
  return (
    <div className="z-5 mx-auto flex w-full max-w-(--breakpoint-sm) flex-col items-center justify-between px-5 pb-4 lg:mb-6 lg:max-w-full lg:flex-row xl:mb-2 xl:w-327.5 xl:pb-6">
