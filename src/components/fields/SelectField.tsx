  ...
  return (
    <>
      <button
        ...
        disabled={disabled}
        onClick={handleOpen}
        className={`dark:border-navy-600 dark:bg-navy-900 text-navy-700 focus:border-brand-500 focus:ring-brand-500/20 flex min-h-[42px] w-full items-center justify-between gap-2 rounded-2xl border border-gray-200 bg-white px-3 py-2 text-sm transition-all duration-150 outline-none select-none hover:border-gray-300 hover:shadow-sm focus:ring-2 disabled:cursor-not-allowed disabled:opacity-50 dark:text-white dark:hover:border-white/20 ${className ?? ""}`}
      >
