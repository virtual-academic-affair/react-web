const Radio = (props: {
  ...
  return (
    <input
      ...
      name={name}
      type="radio"
      className={`before:contet[""] before:left-50p before:-translate-x-50p relative h-5 w-5 cursor-pointer appearance-none rounded-full border border-gray-300! transition-all duration-200 before:absolute before:top-[3px] before:h-3 before:w-3 before:rounded-full before:transition-all before:duration-200 dark:border-gray-800! ${
        color === "red"
