...
const RelatedMessageView: React.FC<RelatedMessageViewProps> = ({
  ...
  if (loading) {
    return (
      <div className="dark:bg-navy-800 mb-6 flex animate-pulse items-center gap-6 rounded-2xl border border-dashed border-gray-200 bg-gray-50 p-4 dark:border-white/10">
  ...
  return (
    <div className="bg-brand-50/30 dark:border-brand-500/20 dark:bg-brand-500/5 mb-6 flex items-center gap-4 rounded-3xl p-4 pl-6">
      <div className="min-w-0 flex-1">
        <p className="text-brand-500 mb-0.5 mb-2 text-xs font-bold tracking-wider uppercase">
          Từ tin nhắn
        </p>
        <p className="text-navy-700 truncate font-bold dark:text-white">
