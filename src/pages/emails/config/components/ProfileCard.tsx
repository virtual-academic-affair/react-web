...
const ProfileCard: React.FC<ProfileCardProps> = ({ data, loading }) => {
  ...
  return (
    <div>
      ...
      >
        {/* Avatar */}
        <div className="dark:border-navy-900! border-lightPrimary dark:border-navy-900 absolute -bottom-16 flex h-[150px] w-[150px] items-center justify-center rounded-full border-[8px] bg-pink-400">
          {profile.picture ? (
            <img
